...
from dc.constants import IGNORE_INDEX, IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN

from einops import rearrange

from .multimodal_projector.dense_connector import dense_connector_sti, dense_connector_sci, dense_connector_dci
...
class LlavaMetaModel:
    ...
    def initialize_vision_modules(self, model_args, fsdp=None):
        ...
        self.vision_tower_name = model_args.vision_tower.split('/')[-1]
        ...
        if pretrain_mm_mlp_adapter is not None:
            ...
            print('---')
            print('load mm projector weights')
...
class LlavaMetaForCausalLM(ABC):
    ...
    def encode_images(self, images):
        ...
        if self.get_model().config.mm_dense_connector_type == 'sti':
        ...
        elif self.get_model().config.mm_dense_connector_type == 'sci':
        ...
        elif self.get_model().config.mm_dense_connector_type == 'dci':
